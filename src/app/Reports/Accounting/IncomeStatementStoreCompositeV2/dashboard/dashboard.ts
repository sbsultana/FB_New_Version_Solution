...
export class Dashboard {
  ...
  GetData(date: any) {
    ...
    const curl = environment.apiUrl + 'WesternAuto/GetIncomeStatementStoreCompositeV1';
    this.apiSrvc
      .postmethod(this.comm.routeEndpoint + 'GetIncomeStatementStoreCompositeV1', obj)
      .subscribe(
        (x) => {
