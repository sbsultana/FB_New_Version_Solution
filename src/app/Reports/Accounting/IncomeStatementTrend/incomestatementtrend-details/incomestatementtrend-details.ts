...
@Component({
  selector: 'app-incomestatementtrend-details',
  standalone: true,
  imports: [NgStyle, SharedModule],
  templateUrl: './incomestatementtrend-details.html',
  styleUrl: './incomestatementtrend-details.scss'
})
export class IncomestatementtrendDetails {
  @Input() Fsdetails: any;
  as_id: any = [];
  FSDetailsData: any = [];
  pageNumber: any = 1;
