...
@Component({
  selector: 'app-salesgrossexecutive-details',
  standalone: true,
  imports: [SharedModule, FilterPipeModule],
  providers: [FilterPipe],
  templateUrl: './salesgrossexecutive-details.html',
  styleUrl: './salesgrossexecutive-details.scss',
})
export class SalesgrossexecutiveDetails {
        ...
        if (res.status == 200) {
          ...
          if (res.response != undefined) {
            if (res.response.length > 0) {
              ...
              const worksheet = workbook.addWorksheet('Sales Gross (Executive) Details');
              ...
              const ReportFilter = worksheet.addRow(['Sales Gross (Executive) Details']);
              ...
              workbook.xlsx.writeBuffer().then((buffer: any) => {
                ...
                this.shared.exportToExcel(workbook, 'Sales Gross (Executive) Details')
              });
            }
          }
        }
