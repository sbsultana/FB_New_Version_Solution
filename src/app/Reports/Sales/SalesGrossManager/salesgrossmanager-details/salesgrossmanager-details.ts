...
@Component({
  selector: 'app-salesgrossmanager-details',
  standalone: true,
  imports: [SharedModule, FilterPipeModule],
  providers: [FilterPipe],
  templateUrl: './salesgrossmanager-details.html',
  styleUrl: './salesgrossmanager-details.scss',
})
export class SalesgrossmanagerDetails {
        ...
        if (res.status == 200) {
          ...
          if (res.response != undefined) {
            if (res.response.length > 0) {
              ...
              const worksheet = workbook.addWorksheet('Sales Gross (Manager) Details');
              ...
              const ReportFilter = worksheet.addRow(['Sales Gross (Manager) Details']);
              ...
              workbook.xlsx.writeBuffer().then((buffer: any) => {
                ...
                this.shared.exportToExcel(workbook, 'Sales Gross (Manager) Details')
              });
            }
          }
        }
