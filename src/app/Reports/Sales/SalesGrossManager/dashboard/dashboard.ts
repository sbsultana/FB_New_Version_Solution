...
import { SalesgrossmanagerReports } from '../salesgrossmanager-reports/salesgrossmanager-reports';
...
@Component({
  ...
  imports: [SharedModule, SalesgrossmanagerReports],
  standalone: true,
...
export class Dashboard {
  ...
  constructor(public shared: Sharedservice, public setdates: Setdates) {
    ...
    this.shared.setTitle(this.shared.common.titleName + '-Sales Gross (Manager)')
  ...
  GetData() {
    ...
    const curl = this.shared.getEnviUrl() + this.shared.common.routeEndpoint + 'GetSalesGrossManager';
    this.shared.api
      .postmethod(this.shared.common.routeEndpoint + 'GetSalesGrossManager', obj)
      .subscribe(
        (res) => {
  ...
  ngAfterViewInit() {
    ...
    this.shared.api.GetReports().subscribe((data) => {
      ...
      // console.log(data);
      if (data.obj.Reference == 'Sales Gross (Manager)') {
    ...
    this.excel = this.shared.api.getExportToExcelAllReports().subscribe((res) => {
      if (this.excel != undefined) {
        if (res.obj.title == 'Sales Gross (Manager)') {
  ...
  exportToExcel(): void {
    ...
    const worksheet = workbook.addWorksheet('Sales Gross (Manager)');
    ...
    const titleRow = worksheet.addRow(['Sales Gross (Manager)']);
   ...
   worksheet.addRow('');
    ...
    workbook.xlsx.writeBuffer().then((buffer: any) => {
      ...
      this.shared.exportToExcel(workbook, 'Sales Gross Manager')
    });
  }
