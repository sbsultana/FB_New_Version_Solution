...
export class Dashboard {
  ...
  constructor(
    ...
    this.shared.setTitle(this.comm.titleName + '-Vehicle Receivables');

    /* --------- HEADER FOR REPORTING --------- */
    const data = {
      title: 'Vehicle Receivables',
  ...
  ngAfterViewInit(): void {
    this.shared.api.getStores().subscribe((res: any) => {
      if (this.shared.common.pageName == 'Vehicle Receivables') {
    ...
    this.shared.api.GetReportOpening().subscribe((res) => {
      if (res.obj.Module === 'Vehicle Receivables') {
    ...
    this.reportgetting = this.shared.api.GetReports().subscribe((data) => {
      if (data.obj.Reference === 'Vehicle Receivables') {
        this.FloorPlanData = [];
        // this.actionType = 'Y';
        this.NoData = false;
    ...
    this.excel = this.shared.api.getExportToExcelAllReports().subscribe((res: any) => {
      if (res && res.obj && res.obj.title == 'Vehicle Receivables' && res.obj.state == true) {
  ...
  Getfloorplansdata(path: any) {
    ...
    this.shared.api.postmethod(this.comm.routeEndpoint + 'GetVehicleReceivables', obj).subscribe(
      (res) => {
